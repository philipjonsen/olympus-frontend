...
describe('<MigrationModal/>', () => {
  ...
  it('should render open component', () => {
    const { container } = render(<MigrationModal open handleClose={() => console.log('handleClose')} />)
    expect(container).toMatchSnapshot()
  })
  ...
  it('should render user account v1 assets and estimated v2 amounts', async () => {
    ...
    const migrationModal = <MigrationModal open handleClose={() => console.log('handleClose')} />
